            ...
            <div x-data="openEndedData('${this.mode}', '${this.questionId}')"
                ...
                <div x-show="selected && mode === 'edit'"
                    ...
                    <div class="flex items-center gap-1 question-card-toolbar">
                        ...
                        <button onclick="openOpenEndedSettingsModal()" class="text-webropol-gray-500 hover:text-webropol-primary-600 hover:bg-webropol-primary-50 transition-colors" title="Settings"><i class="fal fa-cog"></i></button>
