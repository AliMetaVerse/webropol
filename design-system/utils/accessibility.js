...
export class AccessibilityUtils {
  ...
  static addSkipLink(targetId, text = 'Skip to main content') {
    ...
    skipLink.className = 'sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-webropol-primary-600 focus:text-white focus:rounded-lg';
