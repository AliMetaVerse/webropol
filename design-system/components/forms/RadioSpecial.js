/**
 * Webropol Radio Special Component
 * A radio input styled inside a rounded badge for clear, large click targets
 *
 * Attributes:
...
export class WebropolRadioSpecial extends BaseComponent {
  ...
  render() {
    ...
    const badgeClasses = this.classNames(
      'condition-badge inline-flex items-center gap-2 rounded-lg border border-white transition-colors select-none',
...
customElements.define('webropol-radio-special', WebropolRadioSpecial);
